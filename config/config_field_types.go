...
// NewOptAbsoluteURLFromString creates an OptAbsoluteURL from a string. It returns an error if the string is
// not a URL or is a relative URL. If the string is empty, it returns an empty OptAbsoluteURL{}.
