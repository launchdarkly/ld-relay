...
| `maxClientRequestBodySize`         | `MAX_CLIENT_REQUEST_BODY_SIZE`        |   Unit   | none    | Maximum size of a `REPORT` request body that Relay will read when evaluating flags for a client-side, mobile, or server-side SDK. _(9)_                                                                                                                                                                                                                                                                                                                                             |
