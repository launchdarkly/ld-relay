...
| `disableInternalUsageMetrics` | `DISABLE_INTERNAL_USAGE_METRICS` | Boolean  | `false` | Turn off the sending of usage statistics to LaunchDarkly. _**Deprecated**_. _(5)_                                                                                                                                                                                                                                                                                                                                                                                                  |
...
**Please note that this option is deprecated in v7 and removed in v8.**
