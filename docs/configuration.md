...
| `maxClientWriteTime`               | `MAX_CLIENT_WRITE_TIME`               | Duration | none    | Maximum amount of time that Relay will allow a single write to a streaming connection to take. A client that has stopped reading is disconnected once a write exceeds this, instead of holding the connection and its buffered data open indefinitely.                                                                                                                                                                                                                             |
