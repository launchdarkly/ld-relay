...
* Adopt go-server-sdk v7.17.0 so an upstream 401 retries ([#856](https://github.com/launchdarkly/ld-relay/issues/856)) ([e152af7](https://github.com/launchdarkly/ld-relay/commit/e152af72235f138054843803c3a7801cc8930073))
* Back off big segment synchronization on a rejected SDK key ([#857](https://github.com/launchdarkly/ld-relay/issues/857)) ([6ede85b](https://github.com/launchdarkly/ld-relay/commit/6ede85b0097a142015870b686d97de47671b7e55))
* Classify transport failures as normal, including certificate failures ([#873](https://github.com/launchdarkly/ld-relay/issues/873)) ([c3b6850](https://github.com/launchdarkly/ld-relay/commit/c3b6850493fc865c5a8a890b6cf61c4058e84d88))
* Keep retrying a rejected auto-configuration key ([#866](https://github.com/launchdarkly/ld-relay/issues/866)) ([4bf3bb9](https://github.com/launchdarkly/ld-relay/commit/4bf3bb980bbed60465c7d8916d9bf8fc06031a00))
* Report the auto-configuration stream's health in the status resource ([#870](https://github.com/launchdarkly/ld-relay/issues/870)) ([5c1e3ee](https://github.com/launchdarkly/ld-relay/commit/5c1e3ee872e443419c9bad312311612e5ac7c2a4))
...
* Report an incomplete DynamoDB auto-config cache write ([#874](https://github.com/launchdarkly/ld-relay/issues/874)) ([0964dc0](https://github.com/launchdarkly/ld-relay/commit/0964dc07b091a1ccded8f61cbcaaa4954d2cacc0))
* **security:** redact all credential-bearing URL components in status dbServer ([#846](https://github.com/launchdarkly/ld-relay/issues/846)) ([20effc5](https://github.com/launchdarkly/ld-relay/commit/20effc5bfe73faa6bc4ef6792292d7b680e5f06a))
